...
- **Frontend** : VueJS 3
- **Déploiement** : Docker + docker-compose, sur Raspberry Pi 4 (4 Go RAM)
...
- il faudrait qu'à terme, si la Raspberry ne tient pas la charge, on puisse migrer rapidement et facilement sur une architecture cloud.
